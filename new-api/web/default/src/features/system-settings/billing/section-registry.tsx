    ...
    build: (settings: BillingSettings) => (
      <PaymentSettingsSection
        defaultValues={{
          ...
          AlipayAppPrivateKey: settings.AlipayAppPrivateKey ?? '',
          AlipayPublicKey: settings.AlipayPublicKey ?? '',
          AlipayIsCertMode: settings.AlipayIsCertMode ?? false,
          AlipayIsProduction: settings.AlipayIsProduction ?? false,
          AlipayAppCertSN: settings.AlipayAppCertSN ?? '',
          AlipayAlipayCertSN: settings.AlipayAlipayCertSN ?? '',
          ...
          WechatPrivateKeyPEM: settings.WechatPrivateKeyPEM ?? '',
          WechatPlatformCertPath: settings.WechatPlatformCertPath ?? '',
        }}
        waffoDefaultValues={{
