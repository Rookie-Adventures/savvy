...
export type SiteSettings = {
 ...
 WeComKfUrl: string
  ...
  'CustomPage.Product': string
  'CustomPage.Faq': string
  'CustomPage.Refund': string
  'CustomPage.Contact': string
  'CustomPage.OpenSource': string
  'CustomPage.Product.Enabled': string
  'CustomPage.Faq.Enabled': string
  'CustomPage.Refund.Enabled': string
  'CustomPage.Contact.Enabled': string
  'CustomPage.OpenSource.Enabled': string
}
...
export type BillingSettings = {
  ...
  AlipayIsCertMode: boolean
  AlipayIsProduction: boolean
  AlipayAppCertSN: string
  AlipayAlipayCertSN: string
